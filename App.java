...
public class App {
	public static void main(String[] args) {
		...
		emp.add(new Employee(1, "jani", 85000, 1234567));// adding the value using constructor and "Anonymous Object"with using ArrayList()
		emp.add(new Employee(2, "muthu", 95000, 456789));
